...
const CChip = vue.defineComponent({
    name: 'CChip',
    props: {
        /**
    ...
    setup(props, { attrs, emit, slots, expose }) {
        const chipRef = vue.ref();
        const internalSelected = vue.ref(false);
        const selectedState = vue.computed(() => props.selected !== undefined ? Boolean(props.selected) : internalSelected.value);
        const isFocusable = vue.computed(() => Boolean(!props.disabled && (props.selectable || props.removable)));
        ...
        return () => {
            const removeIconVNode = slots.removeIcon?.() ||
                ...
                vue.h('svg', {
                    ...
                    vue.h('line', { x1: 4, y1: 4, x2: 12, y2: 12 }),
                    vue.h('line', { x1: 12, y1: 4, x2: 4, y2: 12 }),
                ]);
            const children = [
